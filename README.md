...
- [Usage](#usage)
  ...
  - [Auth](#auth)
    - [Login](#login)
    - [Example of a successful API response](#example-of-a-successful-api-response)
    - [Logout](#logout)
    - [Example of a successful API response](#example-of-a-successful-api-response-1)
  - [AI Methods](#ai-methods)
    - [List Methods](#list-methods)
    - [Example of a successful API response](#example-of-a-successful-api-response-2)
  - [AI Engines](#ai-engines)
    - [Get All AI Engines](#get-all-ai-engines)
    - [Example of a successful API response](#example-of-a-successful-api-response-3)
    - [Get AI Engines By Provider](#get-ai-engines-by-provider)
    - [Example of a successful API response](#example-of-a-successful-api-response-4)
    - [Get AI Engine By Name](#get-ai-engine-by-name)
    - [Example of a successful API response](#example-of-a-successful-api-response-5)
  - [Tags](#tags)
    - [List Tags](#list-tags)
    - [Example of a successful API response](#example-of-a-successful-api-response-6)
    - [Create a Tag](#create-a-tag)
    - [Example of a successful API response](#example-of-a-successful-api-response-7)
    - [Get Tag using ID url](#get-tag-using-id-url)
    - [Example of a successful API response](#example-of-a-successful-api-response-8)
    - [Get Tag](#get-tag)
    - [Example of a successful API response](#example-of-a-successful-api-response-9)
    - [Update Tag](#update-tag)
    - [Example of a successful API response](#example-of-a-successful-api-response-10)
    - [Delete Tag](#delete-tag)
    - [Example of a successful API response](#example-of-a-successful-api-response-11)
  - [Prompts](#prompts)
    - [List Prompts](#list-prompts)
    - [Example of a successful API response](#example-of-a-successful-api-response-12)
    - [Create a Prompt](#create-a-prompt)
      - [Example of violate setting value(s) and it's Response(s)](#example-of-violate-setting-values-and-its-responses)
      - [Example of a Error response](#example-of-a-error-response)
    - [Example of a successful API response](#example-of-a-successful-api-response-13)
    - [Update Prompt](#update-prompt)
    - [Example of a successful API response](#example-of-a-successful-api-response-14)
    - [Get Prompt using ID url](#get-prompt-using-id-url)
    - [Example of a successful API response](#example-of-a-successful-api-response-15)
    - [Get Prompt](#get-prompt)
    - [Example of a successful API response](#example-of-a-successful-api-response-16)
    - [Delete Prompt](#delete-prompt)
    - [Example of a successful API response](#example-of-a-successful-api-response-17)
    - [Execute Prompt](#execute-prompt)
    - [Example of a successful API response](#example-of-a-successful-api-response-18)
    - [Get Prompt Result](#get-prompt-result)
    - [Example of a successful API response](#example-of-a-successful-api-response-19)
  - [Logs](#logs)
    - [List Logs](#list-logs)
    - [Example of a successful API response](#example-of-a-successful-api-response-20)
    - [Get Log using ID url](#get-log-using-id-url)
    - [Example of a successful API response](#example-of-a-successful-api-response-21)
    - [Get Log](#get-log)
    - [Example of a successful API response](#example-of-a-successful-api-response-22)
  - [Intelets](#intelets)
    - [List Intelets](#list-intelets)
    - [Example of a successful API response](#example-of-a-successful-api-response-23)
    - [Create an Intelet](#create-an-intelet)
      - [Example of violate setting value(s) and it's Response(s)](#example-of-violate-setting-values-and-its-responses-1)
      - [Example of a Error response](#example-of-a-error-response-1)
    - [Correct data for creation](#correct-data-for-creation)
    - [Example of a successful API response](#example-of-a-successful-api-response-24)
    - [Update Intelet](#update-intelet)
    - [Example of a successful API response](#example-of-a-successful-api-response-25)
    - [Get an Intelet using ID url](#get-an-intelet-using-id-url)
    - [Example of a successful API response](#example-of-a-successful-api-response-26)
    - [Get an Intelet](#get-an-intelet)
    - [Example of a successful API response](#example-of-a-successful-api-response-27)
    - [Delete an Intelet](#delete-an-intelet)
    - [Example of a successful API response](#example-of-a-successful-api-response-28)
    - [Execute Intelet](#execute-intelet)
    - [Example of a successful API response](#example-of-a-successful-api-response-29)
    - [Get Intelet Result](#get-intelet-result)
    - [Example of a successful API response](#example-of-a-successful-api-response-30)
    - [Health](#health)
    - [Example of a successful API response](#example-of-a-successful-api-response-31)
  - [Files](#files)
    - [List Files](#list-files)
    - [Example of a successful API response](#example-of-a-successful-api-response-32)
    - [upload a File](#upload-a-file)
    - [Example of a successful API response](#example-of-a-successful-api-response-33)
    - [Delete File](#delete-file)
    - [Example of a successful API response](#example-of-a-successful-api-response-34)
  - [security](#security)
    - [Create Policy](#create-policy)
    - [Example of a successful API response](#example-of-a-successful-api-response-35)
    - [Update Policy](#update-policy)
    - [Example of a successful API response](#example-of-a-successful-api-response-36)
